...
file = os.path.basename(user_input)
output1 = user_input.rstrip(file)
file_name = file.rstrip('.json')
output2 = "{}_flatten.csv".format(file_name)
out_path = os.path.join(output1,output2)
df.to_csv(out_path)